    ...
    <>
      <div className='w-full h-full mx-auto  max-w-screen-md md:px-lg  px-md'>
        <div className='pt-sm md:pt-0 pb-[124px]'>
          <div className='md:mt-lg border-borderMain/60  divide-borderMain/60  ring-borderMain  bg-background '>
            ...
            <div className='pb-md mb-md border-borderMain/60  divide-borderMain/60  ring-borderMain  bg-transparent'>
              <div className='my-md md:my-lg'>
                <div className='break-words [word-break:break-word] whitespace-pre-line  default font-display text-2xl md:text-3xl font-regular text-textMain  selection:bg-superDuper selection:text-textMain'>
                  {searchQuery}
                </div>
              </div>
            </div>
