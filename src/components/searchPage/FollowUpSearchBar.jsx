...
function FollowUpSearchBar() {
  ...
  return (
    <div className='w-full  border-borderMain/60  divide-borderMain/60  ring-borderMain  bg-transparent'>
      <div className=' flex items-center gap-x-xs transition-all duration-200 border-borderMain/60  divide-borderMain/60  ring-borderMain  bg-transparent'>
        <div className='grow transition-all duration-200'>
          <div className='grow'>
            <div>
              <div className='rounded-full md:p-sm bg-offset '>
                <div className='relative flex items-center'>
                  <div className='w-full outline-none focus:outline-none focus:ring-borderMain font-sans flex items-center      selection:bg-superDuper selection:text-textMain duration-200 transition-all bg-background border text-textMain border-borderMain focus:ring-1 placeholder-textOff shadow-sm rounded-t-[32px] rounded-b-[32px] py-md px-lg pr-[128px] md:pr-[138px]'>
                    <textarea
                      placeholder='Ask follow-up...'
                      className='overflow-auto h-[24px] max-h-[50vh] outline-none w-full flex items-center font-sans duration-200 transition-all caret-superDuper resize-none selection:bg-superDuper selection:text-textMain    bg-background text-textMain placeholder-textOff'
                      value={query}
                      onChange={(e) => setQuery(e.target.value)}
                    />
                  </div>
                  <div></div>
                  <div className='absolute flex items-center gap-sm bg-background  rounded-full right-sm'>
                    <button
                      type='button'
                    ...
                    >
                      <div className='pointer-events-none absolute z-30  opacity-0 shadow-sm transition-all delay-200 duration-200 group-hover:translate-y-0 group-hover:translate-x-0  group-hover:opacity-100 bottom-[120%] translate-y-1'>
                        <div className='py-xs px-sm rounded flex items-center gap-x-sm border-borderMain/60  divide-borderMain/60  ring-borderMain  bg-offsetPlusDark'>
                          <div className='border border-borderMain/40 rounded py-two px-xs default text-[11px] font-bold tracking-wide font-mono leading-none uppercase text-textMain  selection:bg-superDuper selection:text-textMain'>
